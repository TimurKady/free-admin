...
class Adapter:
    ...
    model_modules = [
        "contrib.admin.adapters.tortoise.users",
        "contrib.admin.adapters.tortoise.setting",
        "contrib.admin.adapters.tortoise.groups",
        "contrib.admin.adapters.tortoise.content_type",
    ]
