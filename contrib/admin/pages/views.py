...
class BuiltinPagesRegistrar:
    ...
    def register(self, site: AdminSite) -> None:
        @site.register_view(path=self.views_prefix, name=self.views_title, icon=self.views_icon)
        ...
        @site.register_view(path=self.orm_prefix, name=self.orm_title, icon=self.orm_icon)
